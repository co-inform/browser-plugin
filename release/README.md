...
The last version of the Co-Inform Plugin Extension is the [4.4.0 beta](https://github.com/co-inform/browser-plugin/raw/master/release/coinform-extension-v4_4_0_beta.zip), present in this same folder.
