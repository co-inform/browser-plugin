...
The last version of the Co-Inform Plugin Extension is the [4.1.0 RV](https://github.com/co-inform/browser-plugin/raw/master/release/coinform-extension-v4_1_0_rv.zip), present in this same folder.
