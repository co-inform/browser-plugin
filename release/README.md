...
The last version of the Co-Inform Plugin Extension is the [5.1 beta](https://github.com/co-inform/browser-plugin/raw/master/release/coinform-extension-vlast.zip), present in this same folder.
