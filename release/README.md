...
The last version of the Co-Inform Plugin Extension is the [4.1.1 RV Beta](https://github.com/co-inform/browser-plugin/raw/master/release/coinform-extension-v4_1_1_rv_beta.zip), present in this same folder.
